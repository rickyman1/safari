...
export default function Hero() {
  return (
    <section
      className="h-screen flex flex-col justify-center items-center bg-cover bg-center bg-no-repeat text-center px-6 relative"
      style={{ backgroundImage: "url('/images/kenya-safari.jpg')" }}
    >
      <div className="absolute inset-0 bg-gradient-to-r from-green-100 via-emerald-200 to-green-300 opacity-70"></div>
